...
using Day07_Data_access.Models;

namespace Day07_Data_access.Controllers
{
    public class HoaDonsController : Controller
    {
        private readonly K64cnt2dbContext _context;

        public HoaDonsController(K64cnt2dbContext context)
        {
            _context = context;
        }
        ...
        {
            var k64cnt2dbContext = _context.HoaDons.Include(h => h.MaKhaHangNavigation);
        ...
        {
            ViewData["MaKhaHang"] = new SelectList(_context.KhachHangs, "Id", "DienThoai");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,MaHoaDon,MaKhaHang,NgayHoaDon,NgayNhan,HoTenKhachHang,Email,DienThoai,DiaChi,TongTriGia,TrangThai")] HoaDon hoaDon)
        {
            ...
            ViewData["MaKhaHang"] = new SelectList(_context.KhachHangs, "Id", "DienThoai", hoaDon.MaKhaHang);
            return View(hoaDon);
        }
