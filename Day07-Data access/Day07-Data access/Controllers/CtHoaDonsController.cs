...
namespace Day07_Data_access.Controllers
{
    public class CtHoaDonsController : Controller
    {
        ...
        {
            ViewData["HoaDonId"] = new SelectList(_context.HoaDons, "Id", "DiaChi");
        ...
        public async Task<IActionResult> Create([Bind("Id,HoaDonId,SanPhamId,SoLuongMua,DonGiaMua,ThanhTien,TrangThai")] CtHoaDon ctHoaDon)
        {
            ...
            ViewData["HoaDonId"] = new SelectList(_context.HoaDons, "Id", "DiaChi", ctHoaDon.HoaDonId);
            ViewData["SanPhamId"] = new SelectList(_context.SanPhams, "Id", "MaSanPham", ctHoaDon.SanPhamId);
            return View(ctHoaDon);
        }
