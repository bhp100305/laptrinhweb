...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=127.0.0.1;Database=K64CNT2DB;User Id=sa;Password=HuyPhu@999;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CtHoaDon>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__CT_HOA_D__3214EC27D9ED6A9D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HOA_DON__3214EC270531CD5C");

            entity.ToTable("HOA_DON");

            entity.HasIndex(e => e.MaHoaDon, "UQ__HOA_DON__835ED13A48FB108E").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__KHACH_HA__3214EC2769D17F6D");

            entity.ToTable("KHACH_HANG");

            entity.HasIndex(e => e.DienThoai, "UQ__KHACH_HA__1F031876307D71D8").IsUnique();

            entity.HasIndex(e => e.MaKhachHang, "UQ__KHACH_HA__88D2F0E4DA882175").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__KHACH_HA__A9D10534A0AB18A7").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__LOAI_SAN__3214EC278DFC90FD");

            entity.ToTable("LOAI_SAN_PHAM");

            entity.HasIndex(e => e.MaLoai, "UQ__LOAI_SAN__730A57589C4EB3AA").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__QUAN_TRI__3214EC27D4B406E2");

            entity.ToTable("QUAN_TRI");

            entity.HasIndex(e => e.TaiKhoan, "UQ__QUAN_TRI__D5B8C7F05B00ACD7").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SAN_PHAM__3214EC276D0D5F1D");

            entity.ToTable("SAN_PHAM");

            entity.HasIndex(e => e.MaSanPham, "UQ__SAN_PHAM__FAC7442C3ACC8287").IsUnique();
